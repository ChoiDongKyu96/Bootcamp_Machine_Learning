...
#    Updated: 2020/05/30 03:05:48 by dochoi           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
class MyLogisticRegression(object):
    ...
    def __init__(self, thetas, alpha=0.3, n_cycle=1000):
        self.alpha = alpha
...
mylr.fit_(X, Y)
# mylr.thetas = np.array([[ 1.04565272], [ 0.62555148], [ 0.38387466], [ 0.15622435], [-0.45990099]])
print(mylr.thetas)
print(mylr.predict_(X))
print(mylr.cost_(X,Y))